...
#include "com_altruistic_control_server_proxy.h"

#include <QtDBus/QDBusConnection>
#include <QString>

class ServerDBusClient: public ComAltruisticControlServerInterface
{
    Q_OBJECT
public:
    ServerDBusClient
        ...
        : ComAltruisticControlServerInterface
            (
            aBusName,
            aObjectPath,
            aConnection,
